...
function About() {
    ...
    return (
        <>
            ...
            <Mobile>
                <Container>
                    <div className="m_qnaBox">
                        <div className="m_qnaTitle">
                            <p>ABOUT</p>
                            <hr />
                        </div>
                        <div className="m_qnaContent">
                            <div
                                className="m_cardNews"
                                data-aos="fade-right"
                                data-aos-duration="1300"
                            >
                                <div className="m_cardNews_img">
                                    <img
                                        alt="cardNews img"
                                        src={informationIcon}
                                    />
                                </div>
                                <div className="m_cardNews_content">
                                    <p className="m_cardNews_title">
                                        스쿰(SKHUM)이 뭔가요?
                                    </p>
                                    <p className="m_cardNews_subContent">
                                        <p>
                                            스쿰은, 성공회대학교 비교과
                                            마일리지인 SungKongHoe University
                                            Mileage의 약자로, SKHUM(스쿰)이라
                            ...
                            >
                                ...
                                <div className="m_cardNews_content">
                                    <p className="m_cardNews_title">주의!</p>
                                    <p className="m_cardNews_subContent">
                                        <p>
                                            프로그램 참여 중, 중도 포기하면
                                            마일리지는 적립되지 않으니 끝까지
