                    ...
                    >
                        ...
                        <div className="cardNews_content">
                            ...
                            <p className="cardNews_subContent">
                                ...
                                >
                                    스쿠밍도 스쿰 마일리지 랭킹을 제공하는
                                    서비스인만큼, 재학생 모두가 참여할 수
                                    있습니다!
                                </p>
                            </p>
                        </div>
                        ...
                        <div className="cardNews_content">
                            ...
                            <p className="cardNews_subContent">
                                <p>
                                    ...
                                    참여하고, 이수 완료 시 적립 됩니다.정확한
                                    점수는 학기 말에 종합정보시스템에서 확인
                                    가능합니다.
                                </p>
                                <p
                                    style={{
                                ...
                                >
                                    스쿠밍에서는 학기 중 자신이 얼마만큼의
                                    마일리지를 모았는지 직접 체크하며 재학생
                                    랭킹에 참여합니다.
                                </p>
                                <p
                                    style={{
                                ...
                                >
                                    마이페이지의 마일리지 페이지에서 활동을
                                    완료한 프로그램을 체크하고, 마일리지를
                                    적립받아보세요!
                                </p>
                            </p>
                        </div>
                    ...
                    >
                        ...
                        <div className="cardNews_content">
                            ...
                            <p className="cardNews_subContent">
                                ...
                                <p>
                                    각 프로그램별 마일리지 점수는 상이하며, 학기
                                    별로 변동될 수 있으니 공지를 확인해주세요!
                                </p>
                                <p>
