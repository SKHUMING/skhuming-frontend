...
export const Container = styled.div`
    ...
    .m_awardTitle > .m_awardTitleBox > p,
    .m_qnaTitle > p {
        font-size: 20px;
        font-weight: bold;
        margin-top: 5vh;
    ...
    /* .m_cardNews:nth-child(odd) {
        margin-right: 20vw;
    }

    .m_cardNews:nth-child(even) {
        margin-left: 14vw;
    } */
    ...
    .m_cardNews_subContent {
        margin: 0;
        font-size: 10rem;
        color: #204782;
    }
    .m_cardNews_subContent > p {
        margin: 0.7vh 0;
    }
